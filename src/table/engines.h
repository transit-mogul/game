...
static const EngineInfo _orig_engine_info[] = {
	...
	MW(  1827,  20,  20,  50, CT_PASSENGERS  , T|A|S), //  27 Passenger Carriage
	MW(  1827,  20,  20,  50, CT_MAIL        , T|A|S), //  28 Mail Van
	...
	MW(  1827,  20,  20,  50, CT_PASSENGERS  , T|A|S), //  57 Passenger Carriage
	MW(  1827,  20,  20,  50, CT_MAIL        , T|A|S), //  58 Mail Van
	...
	MW(  1827,  20,  20,  50, CT_PASSENGERS  , T|A|S), //  89 Passenger Carriage
	MW(  1827,  20,  20,  50, CT_MAIL        , T|A|S), //  90 Mail Van
